...
SECRET_KEY = 'django-insecure-lhx@c89%a_0y068f1j^jlc9ny)5r3ad!c#naky3$)cpgkuga1-'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # This is where the files will be stored on your filesystem
